...
export type ExerciseStoreActions = {
	...
	setCurrentExerciseInputValue: (id: string, newValue: number | undefined) => void;
...
export type ExerciseStoreData = ExerciseStoreProps & ExerciseStoreActions & ExerciseStoreAttributes;
