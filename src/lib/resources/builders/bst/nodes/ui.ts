...
export function executeLayout(node: BSTUILayoutNode, ctx: Scope): BSTUILayoutNode {
...
export function executeParagraph(node: BSTUIParagraphNode, ctx: Scope): BSTUIParagraphNode {
...
export function executeWidget<Id extends WidgetId>(node: BSTUIWidgetBlockNode<Id>, ctx: Scope) {
